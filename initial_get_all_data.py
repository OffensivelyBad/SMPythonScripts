...
for s in survey_list:
    ...
    detail_response_detail_json = detail_response_json["data"]

    #get all the survey header data
    if 'title' in detail_response_detail_json:
    
        survey_title["text"] = detail_response_detail_json["title"]["text"]
        survey_title["enabled"] = detail_response_detail_json["title"]["enabled"]
        survey_title["survey_id"] = detail_response_detail_json["survey_id"]
        survey_title["date_created"] = detail_response_detail_json["date_created"]
        survey_title["question_count"] = detail_response_detail_json["question_count"]
        survey_title["date_modified"] = detail_response_detail_json["date_modified"]
        survey_title["num_responses"] = detail_response_detail_json["num_responses"]

        for page in detail_response_detail_json["pages"]:
            for question in page["questions"]:
                #capture the questions
                quest = {}
                quest["survey_id"] = detail_response_detail_json["survey_id"]
        ...
        f = csv.writer(open("surveys"+str(incrementor)+".csv", "wb+"))
        #write CSV header
        ...
        f = csv.writer(open("questions"+str(incrementor)+".csv", "wb+"))
        #write a header
        ...
        f = csv.writer(open("answers"+str(incrementor)+".csv", "wb+"))
        #write a header
        ...
        f = csv.writer(open("respondents"+str(incrementor)+".csv", "w"))
        #write a header
        ...
        f = csv.writer(open("responses"+str(incrementor)+".csv", "w"))
        #write a header
